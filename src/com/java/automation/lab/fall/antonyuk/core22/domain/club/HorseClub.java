...
public class HorseClub {
    ...
    public HorseClub(String name, Address address, List<Client> clients, List<Horse> horses, List<Employee> employees,
                     RidingHall ridingHall, Stable stable, List<Competition> competitions) throws InvalidNameException {
        this.setName(name);
